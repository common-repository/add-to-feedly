...
function ADD_TO_FEEDLY_showimage($feeds='http://feeds.feedburner.com/davidmerinas',$lang="es",$custom=""){
		...
		$url="https://feedly.com/i/subscription/feed%2F".urlencode($feeds);
		if($custom!="")
		{
